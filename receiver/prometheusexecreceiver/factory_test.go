...
func TestCreateTraceAndMetricsReceiver(t *testing.T) {
	...
	traceReceiver, err = factory.CreateTracesReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, receiver, nil)
	...
	_, err = factory.CreateMetricsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, receiver, nil)
	assert.NotNil(t, err)

	// Test CreateMetricsReceiver
	receiver = cfg.Receivers["prometheus_exec/test"]
	metricReceiver, err = factory.CreateMetricsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, receiver, nil)
