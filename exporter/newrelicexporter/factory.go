...
func createTracesExporter(
	...
	exp, err := newExporter(componentSettings.Logger, &componentSettings.ApplicationStartInfo, traceConfig, telemetry.NewSpanRequestFactory)
	if err != nil {
		return nil, err
	}
...
func createMetricsExporter(
	...
	exp, err := newExporter(componentSettings.Logger, &componentSettings.ApplicationStartInfo, metricsConfig, telemetry.NewMetricRequestFactory)
	if err != nil {
		return nil, err
	}
...
func createLogsExporter(
	...
	exp, err := newExporter(componentSettings.Logger, &componentSettings.ApplicationStartInfo, logsConfig, telemetry.NewLogRequestFactory)
	if err != nil {
		return nil, err
	}
